...
public class UserChangeRestorationStepState : IState<UserChangeRestorationStepStateProfile, UserChangeRestorationStepTriggerProfile>
{
    public long UserId { get; }
    public RestorationSteps RestorationStep { get; set; }
    
    public StateMachine<UserChangeRestorationStepStateProfile, UserChangeRestorationStepTriggerProfile> StateMachine { get; }

    public UserChangeRestorationStepState(long userId)
    {
        UserId = userId;
        StateMachine =
            new StateMachine<UserChangeRestorationStepStateProfile, UserChangeRestorationStepTriggerProfile>(UserChangeRestorationStepStateProfile
               .Ready);
        
        StateMachine.Configure(UserChangeRestorationStepStateProfile.Ready)
                    .Permit(UserChangeRestorationStepTriggerProfile.Begin, UserChangeRestorationStepStateProfile.RestorationStepUpdating);
