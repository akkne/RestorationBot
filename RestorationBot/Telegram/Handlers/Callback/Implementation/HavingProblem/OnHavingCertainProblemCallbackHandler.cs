...
public class OnHavingCertainProblemCallbackHandler : ICallbackHandler
{
    ...
    public OnHavingCertainProblemCallbackHandler(ICallbackGenerator callbackGenerator, IMessageTextGenerator textGenerator)
    {
    ...
    private async Task OnHavingCertainProblemAsync(int problemIndex, User userFrom, ITelegramBotClient botClient, CancellationToken cancellationToken)
    {
