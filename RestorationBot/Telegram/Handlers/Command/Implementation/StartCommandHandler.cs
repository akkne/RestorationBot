...
public class StartCommandHandler : ICommandHandler
{
    ...
    public StartCommandHandler(IUserRegistrationStateStorageService storageService,
                               IUserRegistrationService userRegistrationService, ICallbackGenerator callbackGenerator)
    {
                                         ...
                                         CancellationToken cancellationToken)
    {
        ...
        await botClient.SendMessage(message.From.Id, welcomeMessage, replyMarkup: replyMarkup,
            cancellationToken: cancellationToken);
        ...
        List<InlineKeyboardButton> inlineKeyboardButtons =
            new List<int> { 1, 2, 3 }.Select(x =>
                ...
                {
                    CallbackData =
                        _callbackGenerator.GenerateCallbackOnChoosingRestorationStep((RestorationSteps)(x - 1))
                }).ToList();

        await botClient.SendMessage(message.From.Id, choosingStepMessage, ParseMode.Html,
